...
(function () {
  ...
  /* ---------- Hi-fi screens grid ---------- */
  var SCREENS = [
    '首页.jpg', '商城.jpg', '课程.png', '我的.png', '轻wow会员.png', '商品.jpg',
    '步数pk.jpg', '朋友圈.jpg', '音乐库.jpg', '马拉松.jpg', '红包挑战.jpg', '身体档案.jpg',
    '我的跑步.jpg', '我的骑行.jpg', '我的计步.jpg', '我的动态.jpg', '我的课程.jpg', '饮食改善.jpg',
    '饮食详情.jpg', '马拉松挑战.jpg', '八公里挑战赛.jpg', '导入页1.jpg', '导入页2.jpg', '导入页3.jpg'
  ];
  var grid = document.getElementById('screensGrid');
  var html = '';
  SCREENS.forEach(function (name) {
    var label = name.replace(/\.(jpg|png)$/, '');
    html += '<div class="screen-cell" data-hover><img loading="lazy" src="./assets/qingwow/hifi/' +
      encodeURIComponent(name) + '" alt="轻WOW ' + label + '"></div>';
  });
  grid.innerHTML = html;
